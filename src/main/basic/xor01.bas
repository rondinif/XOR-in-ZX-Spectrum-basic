...
#                : performs in 0.26 sec. x256: 34.00 sec. 
#                              0.24 sec. x256: 34.56 sec.
#                              0.24 sec. x256: 34.18 sec.
# ============================================================================
   2 CLS : PRINT TAB 5;"XOR TESTING: 01"
   3 PRINT " (a AND NOT b) OR (b AND NOT a) "
   4 PRINT "--------------------------------"
   5 DEF FN t()=((65536*PEEK 23674+256*PEEK 23673+ PEEK 23672)/50)
   7 DEF FN x(a,b)=(a AND NOT b) OR (b AND NOT a)
   9 LET t1=FN t()

...
# version        : 1.0.0  
# note           : ABS (A-B)
#                : performs in 0.20 sec. x256: 19.56 sec. 
# ============================================================================
   2 CLS : PRINT TAB 5;"XOR TESTING: 05b"
   3 PRINT " ABS (A-B) ..without FN "
   4 PRINT "--------------------------------"
   5 DEF FN t()=((65536*PEEK 23674+256*PEEK 23673+ PEEK 23672)/50)
   7 REM FN x(a,b)=(ABS (A-B))
   9 LET t1=FN t()
  10 FOR a=0 TO 1 : REM left operand
  20 FOR b=0 TO 1 : REM right operand
  30 LET r=ABS (A-B) : REM compute xor
  40 PRINT "a:";a;" b:";b;" => ";r
  50 NEXT b
  60 NEXT a 
  65 LET t2=FN t()
 ...
 130 LET r=ABS (A-B) : REM compute xor
 150 NEXT b
 160 NEXT a 
 165 NEXT i
 166 LET t3=FN t()

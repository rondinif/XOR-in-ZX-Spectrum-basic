...
# date           : 20170923
# version        : 1.0.0  
# note           : x(a,b)=(NOT NOT a <> NOT NOT b)
#                : performs in 0.26 sec. x256: 32.38 sec. 
#                              0.24 sec. x256: 32.54 sec.
# ============================================================================
   2 CLS : PRINT TAB 5;"XOR TESTING: 03"
   3 PRINT " x(a,b)=(NOT NOT a <> NOT NOT b) "
   4 PRINT "--------------------------------"
   5 DEF FN t()=((65536*PEEK 23674+256*PEEK 23673+ PEEK 23672)/50)
   7 DEF FN x(a,b)=(NOT NOT a <> NOT NOT b)
   9 LET t1=FN t()
